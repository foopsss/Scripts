...
press_enter() {
# Cuando se termina de ejecutar una acción, se muestra un mensaje para continuar.
    echo
...
incorrect_selection() {
# En caso de que la selección realizada no sea la correcta, muestro un mensaje de error.
